...
export const games: GameInfo[] = [
  ...
  { id: 'beaver', title: 'Бобёр строит мост', subtitle: 'Предложения', description: 'Собирай предложения из круглых брёвен и помоги бобру перейти лесную реку.', color: '#61bdda', modes: beaverModes, instruction: ['Прочитай слова на круглых брёвнах.', 'Передавай их бобру в правильном порядке.', 'Круглая стрелка снимает последнее бревно, а кнопка с веником очищает весь мост.', 'Когда предложение готово, нажми на бобра, чтобы он пошёл по мосту.'] },
]
